...
class Thumbnailer {
 public:
  ...
  // Returns the PSNR value of a re-encoded WebPPicture at given config.
  // Returns -1 on errors.
  float GetPSNR(WebPPicture* const pic, const WebPConfig& config);

  // Returns the size of a re-encoded WebPPicture at given config in bytes.
  // Returns -1 on errors.
  int GetSize(WebPPicture* const pic, const WebPConfig& config);
